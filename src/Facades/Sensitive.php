 ...
 * @method static static setDisturbs(iterable $disturbList = []) 设置干扰因子
 ...
 * @method static static addWords(iterable $wordsList) 添加敏感词
 * @method static static addWordsFromFile(string $filename) 从文件中读取并添加敏感词
 * @method static string filter(string $text) 过滤敏感词
 * @method static \Generator search(string $text, bool $hasReplace = false) 查找对应敏感词
 * @method static bool check(string $text) 查找是否存在敏感词
 */
